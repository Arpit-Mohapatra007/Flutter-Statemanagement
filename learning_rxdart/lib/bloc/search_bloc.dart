...
import 'package:learning_rxdart/bloc/search_result.dart';
...
class SearchBloc {
 ...
 final Stream<SearchResult?> results;
  ...
  factory SearchBloc({required Api api}) {
    ...
    final Stream<SearchResult?> results = textChanges.distinct().debounceTime(const Duration(milliseconds: 300)).switchMap<SearchResult?>((String searchTerm){
