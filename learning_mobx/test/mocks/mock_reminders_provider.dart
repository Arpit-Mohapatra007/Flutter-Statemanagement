...
class MockRemindersProvider implements RemindersProvider {
  ...
  @override
  Future<void> deleteAllDocument({required String userId}) => Future.delayed(oneSecond);

  @override
  Future<void> deleteReminderWithId(ReminderId id, {required String userId}) => Future.delayed(oneSecond);

  @override
  Future<Iterable<Reminder>> loadReminders({required String userId}) => mockReminders.toFuture(oneSecond);

  @override
  Future<void> modify({required String userId, required ReminderId id, required bool isDone}) => Future.delayed(oneSecond);
