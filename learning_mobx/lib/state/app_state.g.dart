...
mixin _$AppState on _AppState, Store {
  ...
  ObservableList<Reminder> get sortedReminders =>
      (_$sortedRemindersComputed ??= Computed<ObservableList<Reminder>>(
        () => super.sortedReminders,
  ...
  late final _$remindersAtom = Atom(
    name: '_AppState.reminders',
    context: context,
  );
  ...
  late final _$createReminderAsyncAction = AsyncAction(
    '_AppState.createReminder',
    context: context,
  );
  ...
  late final _$_loadRemindersAsyncAction = AsyncAction(
    '_AppState._loadReminders',
    context: context,
  );
  ...
  late final _$_registerOrLoginAsyncAction = AsyncAction(
    '_AppState._registerOrLogin',
    context: context,
  );
