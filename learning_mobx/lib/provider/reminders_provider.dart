...
class FirestoreRemindersProvider implements RemindersProvider {
  @override
  Future<ReminderId> createReminder({required String userId, required String text, required DateTime creationDate}) async {
  ...
  @override
  Future<void> deleteAllDocument({required String userId}) async {
  ...
  @override
  Future<void> modify({required String userId, required ReminderId id, required bool isDone}) async {
